...
import { IProducto } from '../Interfaces/iproductos';// Asegúrate de crear esta interfaz

@Injectable({
  providedIn: 'root'
})
export class ProductoService {
  apiurl = 'http://localhost/sexto/Clases/Clase5/controllers/productos.controller.php?op=';
